...
라이브러리/기술 : Firebase (Crashlystic, Messaging), Room, Navigation, MVVM Pattern, AAC, lifecycle(viewmodel, livedata), Glide, RecyclerView, Singleton Pattern, MPAndroidChart, ColorPicker, BottomNavigation, CalendarView 등
