...
data class DrinkWhiskey(
    ...
    @ColumnInfo(name = "whNose") var whNose : String, // 향 목록    // List<String>

    @ColumnInfo(name = "whPalate") var whPalate : String, // 맛 목록    // List<String>
    ...
    @ColumnInfo(name = "whFinish") var whFinish : String, // 피니시 목록    // List<String>
...
data class DrinkWine(
    ...
    @ColumnInfo(name = "wiNose") var wiNose : String, // 향 목록     // List<String>
